...
<div class="container p-0">
	<nav class="py-0 bg-success border-bottom">
		<div class="container d-flex flex-wrap">
			<ul class="nav me-auto">
				...
				<c:choose>
					<c:when test="${isLogOn == true && member != null && member.user_rank_id eq '관리자'}">
						<li class="nav-item"><a
	...
	<nav class="navbar navbar-expand-sm px-5 py-0 border-bottom m-auto">
		<ul class="navbar-nav row">
			<li class="nav-item col p-0 ahover"><a class="nav-link p-3 text-success" id="menu_club"
				href="${pageContext.request.contextPath}/product/pdList.do?cate_id=1&mode=1&filter=&safe=">골프클럽</a></li>
			<li class="nav-item col p-0 ahover"><a class="nav-link p-3 text-success" id="menu_golfitem"
				href="${pageContext.request.contextPath}/product/pdList.do?cate_id=2&mode=1&filter=&&safe=">골프용품</a></li>
			<li class="nav-item col p-0 ahover"><a class="nav-link p-3 text-success" id="menu_golfwear"
