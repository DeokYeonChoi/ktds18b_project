...
<div class="container">
	...
	<div class="row g-4 py-5 row-cols-1 row-cols-lg-3 w-100">
		<div class="feature col w-100">
			...
			<textarea id="txtArea" class="w-100 bg-light" wrap="hard" style="overflow:hidden;" disabled>${view.cs_b_content}</textarea>
		</div>
	</div>
	<form method="post">
		...
		<div class="row row-cols-2 px-3 mb-3">
			...
			<textarea id="staticReply" class="w-100 form-control mb-3"
